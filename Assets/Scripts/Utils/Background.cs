...
namespace RunAndJump {
	public class Background : MonoBehaviour {
		...
		public Sprite _bg;
		public Camera _boundsCam;
		public List<Transform> _bgTransforms;
		public List<SpriteRenderer> _bgRenderers;

		public int _totalX = 3;
		public int _totalY = 1;
		...
		public void CreateInstance(int xPos, int yPos) {
